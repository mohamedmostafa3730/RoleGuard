...
<body class="bg-slate-50 p-12">
    <div class="max-w-4xl mx-auto">
        ...
        <div
            ...
            {{-- Matching 'permissions-creator' --}}
            @canany(['permissions-creator', 'permissions-manage'])
                        ...
                        <tr class="hover:bg-slate-50/50 transition">
                            ...
                            <td class="px-6 py-4 text-right flex justify-end gap-4">
                                <div class="flex justify-end gap-2">
                                    {{-- Matching 'permissions-editor' --}}
                                    @canany(['permissions-editor', 'permissions-manage'])
                                    ...
                                    {{--Matching 'permissions-deleter' --}}
                                    @canany(['permissions-deleter', 'permissions-manage'])
